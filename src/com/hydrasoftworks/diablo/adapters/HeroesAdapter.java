...
public class HeroesAdapter extends ArrayAdapter<Hero>
{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if(convertView == null)
		{
			row = ((LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.heroes_row, parent, false);
		}
		else
		{
			row = convertView;
		...
		heroClass.setText(hero.getLevel() + " " + WordUtils.capitalize(hero.getHeroClass().replace("-", " ")));
		if(hero.isHardcore())
		{
