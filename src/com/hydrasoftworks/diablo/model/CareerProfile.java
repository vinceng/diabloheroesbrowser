...
public class CareerProfile
{
	...
	{
		return new URL(CAREER_PROFILE_URL.replace("{region}", tag.getServer()) + tag.getBattleTagText().replace("#", "-") + "/");
	}
	
	public static CareerProfile getDownloadedProfile(BattleTag battleTag)
	{
		CareerProfile.activeProfile = CareerProfile.downloadedProfiles.get(battleTag.getBattleTagText() + battleTag.getServer());
	...
	{
		return CareerProfile.downloadedProfiles.containsKey(battleTag.getBattleTagText() + battleTag.getServer());
	}
	...
	public void addToDownloadedProfiles(BattleTag battleTag)
	{
		...
		CareerProfile.downloadedProfiles.put(battleTag.getBattleTagText() + battleTag.getServer(), this);
	}
	...
	{
		public static final String[]	LEVELS		= { Progress.NORMAL, Progress.NIGHTMARE, Progress.HELL, Progress.INFERNO };
	...
	{
		CareerProfile.activeProfile = CareerProfile.downloadedProfiles.get(tag + region);
		return CareerProfile.activeProfile;
	}
