...
public class Hero implements Comparable<Hero>
{
	...
	public int compareTo(Hero another)
	{
		if(getLevel() != another.getLevel())
			return Integer.valueOf(getLevel()).compareTo(Integer.valueOf(another.getLevel()));
		return Integer.valueOf(getLastUpdated()).compareTo(Integer.valueOf(another.getLastUpdated()));
	}
