...
public class FollowerInfoView extends LinearLayout
{
	...
	private void init(Context context, AttributeSet attrs)
	{
		...
		TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.FollowerInfoViewStyleable);
		Drawable drawable = typedArray.getDrawable(R.styleable.FollowerInfoViewStyleable_followerBackground);
	...
	public void setItemOnClickListener(int at, OnClickListener onClickListener)
	{
		ImageView iv = (ImageView) findViewById(at);
