...
public class SkillView extends RelativeLayout
{
	...
	private void init(Context context, AttributeSet attrs)
	{
		...
		TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.SkillViewStyleable);
		Drawable drawable = typedArray.getDrawable(R.styleable.SkillViewStyleable_positionIcon);
		int value = typedArray.getInt(R.styleable.SkillViewStyleable_positionText, 0);
